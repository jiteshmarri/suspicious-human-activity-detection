...
source_directory = r'C:\Users\user\OneDrive\Desktop\project jit\yolo11_suspicious_activity-main\images1'  # Change to your actual source directory

# Define the target directories
normal_folder = r'C:\Users\user\OneDrive\Desktop\project jit\yolo11_suspicious_activity-main\dataset_path\Normal'  # Path to Normal folder
suspicious_folder = r'C:\Users\user\OneDrive\Desktop\project jit\yolo11_suspicious_activity-main\dataset_path\Suspicious'  # Path to Suspicious folder
...
for file_name in os.listdir(source_directory):
    ...
    if os.path.isfile(file_path):
        ...
        if file_name.startswith('person_nn_'):
            ...
            if 0 <= number <= 1509:  # Move person_nn_0.jpg to person_nn_10.jpg to Normal folder
