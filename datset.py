...
df = pd.read_csv(r'C:\Users\user\OneDrive\Desktop\project jit\yolo11_suspicious_activity-main\nkeypoint.csv')

dataset_path = r'C:\Users\user\OneDrive\Desktop\project jit\yolo11_suspicious_activity-main\dataset_path'
