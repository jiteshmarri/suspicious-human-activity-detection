...
frame_total = 2000
i = 0
a = 1510 # Start from 848 forcefully

all_data = []

# Define output path for cropped images
output_path_dir = r'C:\Users\user\OneDrive\Desktop\project jit\yolo11_suspicious_activity-main\images1'
...
while cap.isOpened():
    ...
    pa = r'C:\Users\user\OneDrive\Desktop\project jit\yolo11_suspicious_activity-main\images'
...
csv_file_path = r'C:\Users\user\OneDrive\Desktop\project jit\yolo11_suspicious_activity-main\nkeypoint.csv'
